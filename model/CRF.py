...
#         # final_partition /= length
#         # print(final_partition.shape)
#         return final_partition.sum(), scores
#         # return final_partition.mean(), scores
...
#         # tg_energy = (tg_energy.transpose(1,0) / length.unsqueeze(1)).transpose(1,0)
#         tg_energy = tg_energy.masked_select(mask.transpose(1, 0))
...
#         """
#         # end_energy /= length.unsqueeze(1)
#         gold_score = tg_energy.sum() + end_energy.sum()
#         # gold_score = tg_energy.mean() + end_energy.mean()
#         # print(gold_score)
#         return gold_score
